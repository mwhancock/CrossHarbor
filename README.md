...
Personal firmware fork for the Xteink X3/X4 based on **[CrossInk](https://github.com/uxjulia/crossink)**, with selected features from **[CrossCover](https://github.com/StefanTsonev/CrossCover)** and additional integration work for **Hardcover.app**.
